...
package com.liferay.docs.code81.service.persistence.impl;

import com.liferay.docs.code81.exception.NoSuchEmployeeException;
import com.liferay.docs.code81.model.Employee;
import com.liferay.docs.code81.model.EmployeeTable;
import com.liferay.docs.code81.model.impl.EmployeeImpl;
import com.liferay.docs.code81.model.impl.EmployeeModelImpl;
import com.liferay.docs.code81.service.persistence.EmployeePersistence;
import com.liferay.docs.code81.service.persistence.EmployeeUtil;
import com.liferay.docs.code81.service.persistence.impl.constants.EMPPersistenceConstants;
...
public class EmployeePersistenceImpl
	 ...
	 */
	@Override
	public List<Employee> findByDepartmentName(
	 ...
	 */
	@Override
	public Employee findByDepartmentName_First(
			String departmentName,
			OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByDepartmentName_First(
	 ...
	 */
	@Override
	public Employee fetchByDepartmentName_First(
		String departmentName, OrderByComparator<Employee> orderByComparator) {

		List<Employee> list = findByDepartmentName(
	 ...
	 */
	@Override
	public Employee findByDepartmentName_Last(
			String departmentName,
			OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByDepartmentName_Last(
			departmentName, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchByDepartmentName_Last(
		String departmentName, OrderByComparator<Employee> orderByComparator) {
	 ...
	 */
	@Override
	public Employee[] findByDepartmentName_PrevAndNext(
		...
		try {
			...
			array[0] = getByDepartmentName_PrevAndNext(
				session, employee, departmentName, orderByComparator, true);

			array[1] = employee;

			array[2] = getByDepartmentName_PrevAndNext(
				session, employee, departmentName, orderByComparator, false);
	...
	protected Employee getByDepartmentName_PrevAndNext(
		Session session, Employee employee, String departmentName,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_DEPARTMENTNAME_DEPARTMENTNAME_3 =
		"(employee.departmentName IS NULL OR employee.departmentName = '')";
