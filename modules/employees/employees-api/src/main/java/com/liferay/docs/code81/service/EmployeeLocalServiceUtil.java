 ...
 * <code>com.liferay.docs.code81.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.docs.code81.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static Employee addEmp() {
		return getService().addEmp();
	}
	...
	public static List<Employee> findALlEmployees() {
		return getService().findALlEmployees();
	}

	public static List<Employee> findByEmployeeName(String employeeName) {
		return getService().findByEmployeeName(employeeName);
	}
